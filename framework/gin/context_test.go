...
import (
	...
	testdata "github.com/yanshinian/learncoredemo/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/yanshinian/learncoredemo/framework/gin.handlerNameTest$", c.HandlerName())
}
